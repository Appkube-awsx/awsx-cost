...
import (
	...
	"github.com/Appkube-awsx/awsx-wafCostdata/authenticator"
	"github.com/Appkube-awsx/awsx-wafCostdata/client"
...
var GetCostSpikeCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if authFlag {
			...
			wrapperCostSpike(region, crossAccountRoleArn, acKey, secKey, externalId, granularity, startDate, endDate,"AWS WAF")
		}
	},
}
