...
import (
	...
	"github.com/Appkube-awsx/awsx-rdsCostData/authenticator"
	"github.com/Appkube-awsx/awsx-rdsCostData/client"
...
var GetCostSpikeCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if authFlag {
			...
			wrapperCostSpike(region, crossAccountRoleArn, acKey, secKey, externalId, granularity, startDate, endDate,"Amazon Relational Database Service")
		}
	},
}
