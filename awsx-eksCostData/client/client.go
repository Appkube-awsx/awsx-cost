...
import (
	...
	"github.com/Appkube-awsx/awsx-eksCostData/awssession"
...
func GetClient(region string, crossAccountRoleArn string, accessKey string,  secretKey string, externalId string) *eks.EKS{
...
func assumeRole(roleArn string, sessionName string, accesskey string, secretKey string, region string, externalId string) *eks.EKS {
	...
	clusterClient := eks.New(awsSession)
