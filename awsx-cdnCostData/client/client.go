...
import (
	...
	"github.com/Appkube-awsx/awsx-cloudfrontCostData/awssession"
...
func GetClient(region string, crossAccountRoleArn string, accessKey string,  secretKey string, externalId string) *cloudfront.CloudFront{
...
func assumeRole(roleArn string, sessionName string, accesskey string, secretKey string, region string, externalId string) *cloudfront.CloudFront{
	...
	clusterClient := cloudfront.New(awsSession)
